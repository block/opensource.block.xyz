...
just means, using some more letters than are in the typical canonical way you display them, we're actually able to get it into 
...
Yeah, well, definitely can use community help, because each I'm not an expert in each of these languages. So most of the 
